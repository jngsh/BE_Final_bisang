...
public class KakaoPayService {
	...
	///////////////////////////////////////////// baseURL 지정
//		String baseURL = "http://10.10.10.133:8090";
//		String baseURL ="http://localhost:8090";
		String baseURL ="https://boot.peterpet.store";
	///////////////////////////////////////////// baseURL 지정
	...
	public ReadyResponse payReady(String combinedName, int totalPrice, HttpServletRequest request) {
		...
		try {
			...
			parameters.put("approval_url", baseURL + "/bisang/pay/completed");
			parameters.put("cancel_url", baseURL + "/bisang/pay/cancel"); // 결제 취소 시 URLㅇㅇ
			parameters.put("fail_url", baseURL + "/bisang/pay/fail"); // 결제 실패 시 URLㅇㅇ
